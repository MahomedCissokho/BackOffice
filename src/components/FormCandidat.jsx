              ...
              <div className="mb-5">
                  ...
                  <input type="text" name="Numero Carte Electeur" id="nce" placeholder="Numero Carte Electeur"
                      className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                ...
                                <button
                      className="hover:shadow-form w-32 rounded-md bg-[#024ebc]/80 hover:bg-[#024ebc] py-3 px-8 text-center text-base font-semibold text-white outline-none"><Link to="/candidat/infos-sup">Verifier</Link></button>
          </form>
      </div>
  </div>
      </div>
